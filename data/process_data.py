...
def clean_data(df):
    ...
    """Cleans data:
        - cleans and seperates categories into individual columns
    ...
    Returns:
        df : cleaned dataframe with seperated categories
    """
    
    ## Cleaning Process
    # Spliting values and expanding categories columns
    ...
    # cancatenating new categories to data
...
def save_data(df, database_filename):
    ...
    # saving passed dataframe to the specified table in databse
